      ...
      <Modal.Body>
        <Table striped bordered hover responsive>
          <tbody>
            ...
            <tr>
              <td>
                <strong>Monitoring Check</strong>
              </td>
              <td>
                {lead.monitoring_check === 1
                  ? "Yes"
                  : lead.monitoring_check === 0
                  ? "No"
                  : "-"}
              </td>
            </tr>{" "}
            <tr>
              <td>
                <strong>Installation Check</strong>
              </td>
              <td>
                {lead.installation_check === 1
                  ? "Yes"
                  : lead.installation_check === 0
                  ? "No"
                  : "-"}
              </td>
            </tr>
